...
// Pycom modified function. Read ota_info partition and fill array from two otadata structures.
static esp_err_t pycom_read_otadata(const esp_partition_pos_t *ota_info, boot_info_t* boot_info)
{
    ...
    uint32_t entry_addr)
{
    ...
    */
    ...
    ESP_LOGE(TAG, "start: 0x%08x", entry_addr);
