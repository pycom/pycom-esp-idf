...
#define MB_TCP_DEFAULT_PORT             502//(CONFIG_FMB_TCP_PORT_DEFAULT)
#define MB_TCP_STACK_SIZE               4096//(CONFIG_FMB_PORT_TASK_STACK_SIZE)
#define MB_TCP_TASK_PRIO                10//(CONFIG_FMB_PORT_TASK_PRIO)
...
#define MB_TCP_PORT_MAX_CONN            5//(CONFIG_FMB_TCP_PORT_MAX_CONN)
